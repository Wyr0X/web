...
const language_data = {
    ...
    short_desc: {
        spanish: 'Desarrollador de software y apasionado por la informática.',
        english: 'Software developer and passionate about computer science.'
    },
    photo_me_desc: {
    ...
    introduction1: {
        spanish: '¡Hola! Mi nombre es Alexis y llevo más de 10 años metido en el mundo de la informática. Con una formación en \
                    ...
                    computación gráfica, ingenería inversa. Podés revisar la sección de habilidades para ver mis conocimientos con más detalle.',
        english: 'Hello! My name is Alexis and I\'ve been involved in the computer science world for more than 10 years. With a partly formal \
                    and partly self-taught training, I\'ve made my way through the many branches of computer science. To mention a few: apps \
                    development (desktop, web and mobile), cybersecurity, databases, computer graphics, reverse engineering. You can check \
    ...
    education_desc: {
        spanish: 'Aquí presento la educación formal que recibí como desarrollador. Gran parte de mis conocimientos los he adquirido por cuenta propia \
                    pero esta educación me ayudó a partir de una base sólida.',
        english: 'Here I present the formal education I received as a developer. Much of my knowledge I have acquired on my own but this education helped \
